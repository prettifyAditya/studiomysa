...
export default function BlogBanner({ scrollto="" }){
    const [openSocial, setOpenSocial] = useState(null)
    return(
        <div className="banner blogD_banner">
            <div className="bg">
                <Image src='/assets/images/other/service-details.jpg' alt="Blog Details Banner" width="1280" height="740"></Image>
                ...
                <button type="button" className="scroll_down" onClick={scrollto}>
